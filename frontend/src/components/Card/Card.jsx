        ...
        <>
            {plant.owner.trim() === "opponent" && !opponentCardShow ? (
                ...
                >
                    ...
                    >
                        <p data-testid="average-ph-text">
                            {plant.ph_levels.ph_range}
                        </p>
                    </div>
                    <div
                    ...
                    >
                        <p data-testid="water-text">
                            {plant.atmospheric_humidity}
                        </p>
                    </div>
                </article>
            )}
