...
export const PlayGamePage = () => {
    ...
    const pickTopCards = () => {
        setCardsInPlay([openingHand[0], computerHand[0]]);
        setOpeningHand((prev) => {
    ...
    const playerOneWinsComparison = () => {
        computerHand.length === 0 && setGameWinner("Player1");
        setOpeningHand((prev) => {
            setCardsInPlay([]);
            return [...prev, ...cardsInPlay];
        });
    };
    const playerTwoWinsComparison = () => {
        setComputerHand((prev) => {
            openingHand.length === 0 && setGameWinner("Player2");
            setCardsInPlay([]);
            return [...prev, ...cardsInPlay];
        });
    };
    ...
    return (
        <>
            ...
            <h1>Top cards</h1>
            {cardsInPlay && <CardContainer plants={cardsInPlay} />}
